...
public class posController {
        ...
        public double distanceTo(@RequestBody String body){
            try{
                ...
                System.err.println("[Error] SOURCE = MAIN CONTROLLER|JSON Parser exception: "+ ex.getMessage());
                throw new ResponseStatusException(
                        HttpStatus.BAD_REQUEST, "JSON Parser exception", ex);
            }catch(NullPointerException ex){
                System.err.println("[Error] SOURCE = MAIN CONTROLLER|JSON mapping error: element not found: " + ex.getMessage());
                throw new ResponseStatusException(
        ...
        public boolean isInRegion(@RequestBody String body){
            try{
                ...
                if(region.name().isEmpty()){
                    System.err.println("[Error] SOURCE = MAIN CONTROLLER|Illegal named region");
                    throw new ResponseStatusException(
                ...
                System.err.println("[Error] SOURCE = MAIN CONTROLLER|Other error: element not found: " + ex.getMessage());
                throw new ResponseStatusException(
